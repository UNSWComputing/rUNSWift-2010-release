...
class PythonSkill : Skill {
   public:
   explicit PythonSkill(std::string path, std::string pythonclass,
         SkillParams *params, WhichCamera *camera, bool *usePF);
   ~PythonSkill();
   virtual void execute(SkillParams *params, ActionCommand::All *actions,
