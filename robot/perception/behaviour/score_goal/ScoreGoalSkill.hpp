...
class ScoreGoalSkill : Skill {
   ...
   Skill *gotoBall;
   Skill *findBall;
   LineUpBallGoalSkill *lineUpWithGoal;
   CheckBallGoalAlignSkill *checkGoalAlign;
   AlignFootSkill *alignFoot;

   /* Temporary hax till localisation */
   Timer timer;
   float lastBallSeenTime;
   RRCoord lastBallPosition;
   static const int BALL_SEEN_TOLERENCE = 2000;
