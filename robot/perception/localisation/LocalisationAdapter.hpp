...
#include "perception/localisation/KFilter.hpp"
#include "perception/localisation/BallFilter.hpp"
#include "perception/localisation/RobotFilter.hpp"
#include "perception/localisation/SonarMonitor.hpp"
...
class LocalisationAdapter {
   public:
   /* The name of the module, must be same as directory name */
   ...
   bool usingPF;
   void populateLocaliser(Localiser *L);
};
