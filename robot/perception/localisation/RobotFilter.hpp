...
class RobotFilter {
   ...
   public:
      ...
      void update();
   private:
      std::list<RobotObstacle> robots;
      Odometry odometry;
      Odometry prev_odometry;

      RobotType obsRobotTypes[MAX_NUM_ROBOTS];
      RRCoord obsRobotLocations[MAX_NUM_ROBOTS];
      bool obsCanSeeBottom[MAX_NUM_ROBOTS];
      uint16_t obsNumRobots;
      AbsCoord robotPos;
};
