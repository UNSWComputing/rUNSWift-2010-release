...
#include "../../robot/utils/SensorValues.hpp"
...
void SensorTab::updateDataView(Blackboard *blackboard) {
   ...
   for(int i = 0; i < sizeof(Joints::jointCodes)/sizeof(Joints::JointCode); i++) {
   ...
   for(int i = 0; i < sizeof(Sensors::sensorCodes)/sizeof(Sensors::SensorCode); i++) {
